...
# Wrap existing project form so English and translated content share the same project editor.
...
# Migrate translation data if the slug is edited.
english_form = replace_once(
    english_form,
              ...
              {contentLocale === 'en' ? (
                ...
                <div className="admin-form-grid admin-translation-form-grid">
                  ...
                  <label>
                    ...
                    <input
                      value={selectedTranslation.shortTitle}
                      onChange={(event) => updateTranslation({ shortTitle: event.target.value })}
                    />
                  </label>
                  ...
                  <label className="wide">
                    ...
                    <textarea
                      className="large"
                      value={selectedTranslation.overview}
                      onChange={(event) => updateTranslation({ overview: event.target.value })}
                    />
                  </label>
                  ...
                  <label className="wide">
                    ...
                    <textarea
                      className="large"
                      value={selectedTranslation.features.join('\n')}
                      onChange={(event) => updateTranslation({ features: listFromText(event.target.value) })}
                    />
                  </label>
                  ...
                  <label className="wide">
                    ...
                    <textarea
                      className="large"
                      value={challengesToText(selectedTranslation)}
                      onChange={(event) =>
                        updateTranslation({
                  ...
                  <label className="wide">
                    ...
                    <textarea
                      className="large"
                      value={architectureToText(selectedTranslation)}
                      onChange={(event) =>
                        updateTranslation({
                  ...
                  <label className="wide">
                    ...
                    <textarea
                      className="large"
                      value={galleryToText(selectedTranslation)}
                      onChange={(event) =>
                        updateTranslation({
...
# Redirect the old translation route back to the unified admin editor.
...
text = replace_once(
    ...
    '<Route path="/admin/translations" element={<Navigate to="/admin" replace/>}/>',
    'translation route redirect',
)
app.write_text(text, encoding='utf-8')


# Add CSS for locale tabs and the unified editor.
...
.admin-page .admin-locale-tab.active small {
  color: #33411f;
}
