...
replacements = {
    ...
    "copy = replace_once(copy, \"  agentDiscarded: '已丢棄 Agent 修改建議。',\",": "copy = replace_once(copy, \"  agentDiscarded: '已捨棄 Agent 修改。',\",",
    ...
    "copy = replace_once(copy, \"  agentDiscarded: 'Đã bỏ đề xuất của Agent.',\",": "copy = replace_once(copy, \"  agentDiscarded: 'Đã bỏ đề xuất của Agent.',\",",
}
