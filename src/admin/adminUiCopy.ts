...
const en: AdminUiCopy = {
  ...
  agentTitle: 'Global portfolio AI agent',
  agentDraftOnly: 'Works across projects, translations, and technology data · draft only · you decide what gets applied',
  agentYou: 'YOU',
  agentFillEmpty: 'Fill portfolio gaps',
  agentTranslateAll: 'Fill missing translations',
  agentImproveCurrent: 'Focus selected project',
  agentCheckRepository: 'Check GitHub evidence',
  agentPlaceholder: 'Tell the global agent what to change anywhere in the portfolio…',
  agentSend: 'Ask agent',
  ...
  agentFailed: 'Portfolio agent failed.',
  ...
  agentAuditPortfolio: 'Audit entire portfolio',
  ...
  logoUrl: 'Logo URL',
  remove: 'Remove',
  writeChanges: 'Save portfolio changes',
  ...
  publishingPortfolio: 'Saving portfolio data…',
...
const zhCN: AdminUiCopy = {
  ...
  agentTitle: '全局作品集 AI Agent',
  agentDraftOnly: '可操作全部项目、多语言和技术数据 · 只修改草稿 · 是否应用由你决定',
  agentYou: '你',
  agentFillEmpty: '补全作品集缺口',
  agentTranslateAll: '补全缺失翻译',
  agentImproveCurrent: '聚焦当前项目',
  agentCheckRepository: '检查 GitHub 证据',
  agentPlaceholder: '告诉全局 Agent 要修改作品集里的什么内容…',
  agentSend: '发送给 Agent',
  agentThinking: 'Agent 正在处理…',
  agentReviewBeforeApply: '修改草稿已生成，请先检查再应用。',
  agentNoChanges: 'Agent 已回复，但没有提出字段修改。',
  agentFailed: '作品集 Agent 执行失败。',
  agentProposedChanges: '建议修改',
  agentFields: '个字段',
  agentApply: '应用修改',
  agentDiscard: '丢弃',
  agentApplied: 'Agent 修改已应用到草稿，尚未发布。',
  agentDiscarded: '已丢弃 Agent 修改建议。',
  agentPortfolioScope: '全局作品集范围',
  agentCurrentFocus: '当前焦点',
  agentAuditPortfolio: '检查整个作品集',
...
const zhTW: AdminUiCopy = {
  ...
  agentTitle: '全域作品集 AI Agent',
  agentDraftOnly: '可操作全部專案、多語言與技術資料 · 只修改草稿 · 是否套用由你決定',
  agentYou: '你',
  agentFillEmpty: '補全作品集缺口',
  agentTranslateAll: '補全缺失翻譯',
  agentImproveCurrent: '聚焦目前專案',
  agentCheckRepository: '檢查 GitHub 證據',
  agentPlaceholder: '告訴全域 Agent 要修改作品集裡的什麼內容…',
  agentSend: '傳送給 Agent',
  agentThinking: 'Agent 正在處理…',
  agentReviewBeforeApply: '修改草稿已產生，請先檢查再套用。',
  agentNoChanges: 'Agent 已回覆，但沒有提出欄位修改。',
  agentFailed: '作品集 Agent 執行失敗。',
  agentProposedChanges: '建議修改',
  agentFields: '個欄位',
  agentApply: '套用修改',
  agentDiscard: '捨棄',
  agentApplied: 'Agent 修改已套用到草稿，尚未發佈。',
  agentDiscarded: '已丟棄 Agent 修改建議。',
  agentPortfolioScope: '全域作品集範圍',
  agentCurrentFocus: '目前焦點',
  agentAuditPortfolio: '檢查整個作品集',
...
const viLatn: AdminUiCopy = {
  ...
  agentTitle: 'AI Agent toàn bộ portfolio',
  agentDraftOnly: 'Có thể làm việc trên mọi dự án, bản dịch và dữ liệu công nghệ · chỉ sửa bản nháp · bạn quyết định có áp dụng hay không',
  agentYou: 'BẠN',
  agentFillEmpty: 'Bổ sung phần còn thiếu',
  agentTranslateAll: 'Bổ sung bản dịch còn thiếu',
  agentImproveCurrent: 'Tập trung dự án đang chọn',
  agentCheckRepository: 'Kiểm tra bằng chứng GitHub',
  agentPlaceholder: 'Hãy nói AI Agent toàn cục cần sửa gì ở bất kỳ đâu trong portfolio…',
  ...
  agentAuditPortfolio: 'Kiểm tra toàn bộ portfolio',
  ...
  logoUrl: 'URL logo',
  remove: 'Xóa',
  writeChanges: 'Lưu thay đổi portfolio',
  ...
  publishingPortfolio: 'Đang lưu dữ liệu portfolio…',
  published: 'Đã lưu và cập nhật trực tiếp.',
