...
const copy: Record<AppLocale, HomeCopy> = {
  en: {
    ...
    work: {
      ...
      title: 'A compact index of the projects carrying the most weight.',
      description: 'Less gallery, more signal: product scope, technical direction, and the reason each project matters.',
  ...
  'zh-CN': {
    ...
    work: {
      eyebrow: '精选项目',
      title: '把最有分量的项目压缩成一眼能读懂的项目索引。',
      description: '减少巨大的展示图，直接突出产品范围、技术方向，以及每个项目为什么值得看。',
      allProjects: '全部项目 ↗',
      viewProject: '打开项目',
    },
    areas: {
  ...
  'zh-TW': {
    ...
    work: {
      eyebrow: '精選專案',
      title: '把最有份量的專案壓縮成一眼能讀懂的專案索引。',
      description: '減少巨大的展示圖，直接突出產品範圍、技術方向，以及每個專案為什麼值得看。',
      allProjects: '全部專案 ↗',
      viewProject: '開啟專案',
    },
    areas: {
  ...
  'vi-Latn': {
    ...
    work: {
      ...
      title: 'Một chỉ mục gọn cho những dự án có trọng lượng nhất.',
      description: 'Ít hình trưng bày khổng lồ hơn; tập trung vào phạm vi sản phẩm, hướng kỹ thuật và lý do mỗi dự án đáng xem.',
  ...
  'vi-Hani': {
    ...
    work: {
      eyebrow: '各預案重點',
      title: '𠬠只目𥘷朱仍預案固重點一𠸜。',
      description: '少份形影𡘯、𡗉信號欣：範圍產品、方向工藝吧理由每預案值得䀡。',
      allProjects: '各預案 ↗',
      viewProject: '䀡預案',
    },
    areas: {
