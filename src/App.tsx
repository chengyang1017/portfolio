...
function MetadataSync(){
  ...
  useEffect(() => {
    ...
    const page = project?.title ?? (pathname === '/projects' ? 'Projects' : pathname === '/about' ? 'About' : pathname === '/admin' ? 'Admin' : 'Portfolio');
